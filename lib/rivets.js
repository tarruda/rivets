...
(function() {
  ...
  Rivets.binders = {
    ...
    "on-*": {
      ...
      unbind: function(el) {
        if (this.currentListener) {
          return unbindEvent(el, this.args[0], this.currentListener);
        }
      }
    },
    "each-*": {
    ...
    template: {
      ...
      routine: function(el, value) {
        var childNode, data, m, n, view, _i, _j, _len, _len1, _ref, _ref1, _ref2, _results;
        el.innerHTML = value;
        ...
        for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
          ...
          if (childNode.nodeType === 1) {
            _results.push(this.childViews.push(rivets.bind(childNode, data)));
          }
        }
        return _results;
      },
      unbind: function(el) {
        var binding, view, _i, _j, _len, _len1, _ref, _ref1;
        _ref = this.childViews;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          view = _ref[_i];
          view.unbind();
